...
public class KitStub {
    ...
    void startPreparation() {
        ...
        ((Chef) Thread.currentThread()).setChefState(ChefStates.PREPCO);
    }
    ...
    void proceedToPresentation() {
        ...
        con.close();
        ((Chef) Thread.currentThread()).setChefState(ChefStates.DISHPO);
    }
    ...
    void alertTheWaiter() {
        ...
        con.close();
        ((Chef) Thread.currentThread()).setChefState(ChefStates.DILPOR);
    }
    ...
    void cleanUp() {
        ...
        con.close();
        ((Chef) Thread.currentThread()).setChefState(ChefStates.CLOSER);
    }
