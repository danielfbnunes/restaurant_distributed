...
public class KitchenMain
{
    ...
    public static void main (String [] args)
    {
        ...
        kit = new Kitchen(repo, barStub);
        kitInt = new KitchenInterface(kit);
        ...
        while (waitConnection)
            ...
            cliProxy = new ClientProxy(sconi, kitInt);  // lançamento do agente prestador do serviço
            cliProxy.start ();
            }
