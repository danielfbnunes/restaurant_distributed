...
public class TabStub {
    ...
    void saluteTheClient() {
        ...
        con.close();
        ((Waiter) Thread.currentThread()).setWaiterState(WaiterStates.PREMEN);
    }
    ...
    void getThePad() {
        ...
        con.close();
        ((Waiter) Thread.currentThread()).setWaiterState(WaiterStates.TAKORD);
    }
    ...
    void presentTheBill() {
        ...
        con.close();
        ((Waiter) Thread.currentThread()).setWaiterState(WaiterStates.RECPAY);
    }
